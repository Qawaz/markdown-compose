...
internal fun <T> SimpleTableLayout(
    ...
    SubcomposeLayout(modifier = modifier) { constraints ->
        ...
        layout(tableWidth, tableHeight) {
            ...
            rowPlaceables.fastForEachIndexed { rowIndex, cellPlaceables ->
                rowOffsets += y - cellSpacing / 2f
                var x = cellSpacing

                cellPlaceables.fastForEach { cell ->
                    if (rowIndex == 0) {
...
internal fun Modifier.drawTableBorders(
    ...
    rowOffsets.fastForEach { position ->
        drawLine(
            borderColor,
    ...
    columnOffsets.fastForEach { position ->
        drawLine(
            borderColor,
            Offset(position, 0f),
