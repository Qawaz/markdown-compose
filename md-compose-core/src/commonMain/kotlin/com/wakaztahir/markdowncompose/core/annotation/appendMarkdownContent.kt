package com.wakaztahir.markdowncompose.core.annotation
...
import com.wakaztahir.markdowncompose.utils.innerList
 ...
 */
internal fun AnnotatedString.Builder.buildMarkdownAnnotatedString(content: String, node: ASTNode, colors: ColorScheme) {
...
fun AnnotatedString.Builder.appendAutoLink(content: String, node: ASTNode, colors: ColorScheme) {
...
fun AnnotatedString.Builder.appendMarkdownLink(content: String, node: ASTNode, colors: ColorScheme) {
