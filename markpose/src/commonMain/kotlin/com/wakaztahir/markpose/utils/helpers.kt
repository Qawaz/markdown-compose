...
interface DialogContainer {
    @Composable
    fun DialogContainer(onDismissRequest: () -> Unit, title: String, content: @Composable () -> Unit)
}

internal object DefaultDialogContainer : DialogContainer {
    @Composable
    override fun DialogContainer(onDismissRequest: () -> Unit, title: String, content: @Composable () -> Unit) =
        ContainDialog(
            onDismissRequest = onDismissRequest, title = title, content = content
        )
}

@Composable
internal expect fun ContainDialog(onDismissRequest: () -> Unit, title: String, content: @Composable () -> Unit)
